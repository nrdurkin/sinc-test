...
(window.dhtmlXScheduler = window.scheduler = { version: '5.0.0' }),
      ...
      ((window[e] = function(e) {
        ...
        if (e && 'object' == typeof e && !e.tagName) {
          ...
          for (var s in e)
            t[s]
              ? this[t[s]](e[s])
              : 0 === s.indexOf('on') && this.attachEvent(s, e[s]);
        } else i = r.apply(this, arguments);
        return t._patch && t._patch(this), i || this;
      }),
      (window[e].prototype = r.prototype),
  ...
  (dhtmlxAjax = {
    get: function(e, t) {
      ...
      return (
        (i.async = arguments.length < 3), (i.waitCall = t), i.loadXML(e), i
      );
    },
    post: function(e, t, i) {
      var r = new dtmlXMLLoaderObject(!0);
      return (
        (r.async = arguments.length < 4),
        (r.waitCall = i),
        r.loadXML(e, !0, t),
        r
      );
    ...
    return (
      (this.check = function() {
        if (
          e &&
          e.onloadAction &&
          (!e.xmlDoc.readyState || 4 == e.xmlDoc.readyState)
        ) {
          if (!t) return;
          (t = !1),
            dtmlXMLLoaderObject.count++,
            'function' == typeof e.onloadAction &&
              e.onloadAction(e.mainObject, null, null, null, e),
  ...
  (dtmlXMLLoaderObject.prototype.getXMLTopNode = function(e, t) {
    ...
    if (this.xmlDoc.responseXML) {
      ...
      if (0 === r.length && -1 != e.indexOf(':'))
        var r = this.xmlDoc.responseXML.getElementsByTagName(e.split(':')[1]);
      i = r[0];
  ...
  (dtmlXMLLoaderObject.prototype.loadXML = function(e, t, i, r) {
    this.rSeed &&
      ...
      'string' == typeof t
        ? this.xmlDoc.open(t, e, this.async)
        : this.xmlDoc.open(t ? 'POST' : 'GET', e, this.async),
      r
        ? (this.xmlDoc.setRequestHeader(
            'User-Agent',
  ...
  (dtmlXMLLoaderObject.prototype.xmlNodeToJSON = function(e) {
    ...
    for (var i = 0; i < e.childNodes.length; i++) {
      ...
      r &&
        (t[r] || (t[r] = []), t[r].push(this.xmlNodeToJSON(e.childNodes[i])));
    }
    return t;
  }),
  ...
  (dhtmlDragAndDropObject.prototype.preCreateDragCopy = function(e) {
    return (!e && !window.event) || 2 != (e || event).button
      ? window.dhtmlDragAndDrop.waitDrag
        ? ((window.dhtmlDragAndDrop.waitDrag = 0),
          (document.body.onmouseup = window.dhtmlDragAndDrop.tempDOMU),
          (document.body.onmousemove = window.dhtmlDragAndDrop.tempDOMM),
          !1)
        : (window.dhtmlDragAndDrop.dragNode &&
          ...
          e && e.preventDefault ? (e.preventDefault(), !1) : !1)
      : void 0;
  }),
  (dhtmlDragAndDropObject.prototype.callDrag = function(e) {
    ...
    if (!(new Date().valueOf() - t.downtime < 100)) {
      if (!t.dragNode) {
        ...
        if (
          ((t.dragNode = t.dragStartObject._createDragNode(t.dragStartNode, e)),
          !t.dragNode)
        )
          return t.stopDrag();
      ...
      if (t.dragNode.parentNode != window.document.body && t.gldragNode) {
        ...
        (t.dragNode.pWindow = window),
          ...
          document.body.appendChild(t.dragNode),
          (r.dhtmlDragAndDrop.dragNode = t.dragNode);
      }
      (t.dragNode.style.left =
        e.clientX +
        15 +
        (t.fx ? -1 * t.fx : 0) +
        (document.body.scrollLeft || document.documentElement.scrollLeft) +
        'px'),
        (t.dragNode.style.top =
          e.clientY +
          3 +
          (t.fy ? -1 * t.fy : 0) +
  ...
  (dhtmlDragAndDropObject.prototype.calculateFramePosition = function(e) {
    if (window.name) {
      for (
        var t = parent.frames[window.name].frameElement.offsetParent,
          i = 0,
          r = 0;
        t;
  ...
  (dhtmlDragAndDropObject.prototype.stopDrag = function(e, t) {
    ...
    (i.lastLanding = null),
      i.dragNode &&
        i.dragNode.parentNode == document.body &&
        i.dragNode.parentNode.removeChild(i.dragNode),
      (i.dragNode = 0),
      (i.gldragNode = 0),
      (i.fx = 0),
      (i.fy = 0),
  ...
  (dhtmlDragAndDropObject.prototype.stopFrameRoute = function(e) {
    ...
    for (var t = 0; t < window.frames.length; t++)
      try {
        window.frames[t] != e &&
          window.frames[t].dhtmlDragAndDrop &&
          window.frames[t].dhtmlDragAndDrop.stopFrameRoute(window);
      } catch (i) {}
    try {
  ...
  (dhtmlDragAndDropObject.prototype.initFrameRoute = function(e, t) {
    e &&
      ...
      (window.dhtmlDragAndDrop.dragStartNode =
        e.dhtmlDragAndDrop.dragStartNode),
    ...
    for (var r = 0; r < window.frames.length; r++)
      try {
        window.frames[r] != e &&
          window.frames[r].dhtmlDragAndDrop &&
          window.frames[r].dhtmlDragAndDrop.initFrameRoute(
            window,
            !e || t ? 1 : 0
          );
      } catch (i) {}
  ...
  (dtmlXMLLoaderObject.prototype.doXPath = function(e, t, i, r) {
    ...
    if (_isIE)
      return (
        ...
        'single' == r ? t.selectSingleNode(e) : t.selectNodes(e) || new Array(0)
      );
    var s = t;
    t || (t = this.xmlDoc.nodeName ? this.xmlDoc : this.xmlDoc.responseXML),
      t ||
      ...
      -1 != t.nodeName.indexOf('document')
        ? (s = t)
        : ((s = t), (t = t.ownerDocument));
  ...
  (_dhtmlxError.prototype.throwError = function(e, t, i) {
    return this.catches[e]
      ? this.catches[e](e, t, i)
      : this.catches.ALL
      ? this.catches.ALL(e, t, i)
      : (window.alert(
  ...
  (dtmlXMLLoaderObject.prototype.doXPathOpera = function(e, t) {
    ...
    if ('.' == i[0]) r = [t];
      ...
      if ('' !== i[0]) return [];
      (r = (this.xmlDoc.responseXML || this.xmlDoc).getElementsByTagName(
        i[s].replace(/\[[^\]]*\]/g, '')
      )),
        s++;
    }
    ...
    return (
      -1 != i[s - 1].indexOf('[') && (r = this._filterXPath(r, i[s - 1])), r
    );
  }),
  ...
  (dtmlXMLLoaderObject.prototype._getAllNamedChilds = function(e, t) {
    ...
    for (var r = 0; r < e.length; r++)
      for (var s = 0; s < e[r].childNodes.length; s++)
        _isKHTML
          ? e[r].childNodes[s].tagName &&
            e[r].childNodes[s].tagName.toUpperCase() == t &&
            (i[i.length] = e[r].childNodes[s])
          : e[r].childNodes[s].tagName == t &&
            (i[i.length] = e[r].childNodes[s]);
    return i;
  }),
  ...
  (dtmlXMLLoaderObject.prototype.setXSLParamValue = function(e, t, i) {
    ...
    var r = this.doXPath(
      "/xsl:stylesheet/xsl:variable[@name='" + e + "']",
      i,
  ...
  (dhtmlxEventable = function(obj) {
    (obj.attachEvent = function(e, t, i) {
      ...
      (obj.callEvent = function(e, t) {
        return (
          (e = 'ev_' + e.toLowerCase()), this[e] ? this[e].apply(this, t) : !0
        );
      }),
  ...
  (function() {
      ...
      if (c) {
        ...
        if (dhtmlx.message.keyboard) {
          if (13 == i || 32 == i) {
            ...
            scheduler._getClassName(s).indexOf('dhtmlx_popup_button') > -1 &&
            s.click
              ? s.click()
              : (e(c, !0), (r = !0));
          }
    ...
    function s(e) {
      ...
      return (
        ...
        'bottom' == u.position && u.area.firstChild
          ? u.area.insertBefore(t, u.area.firstChild)
          : u.area.appendChild(t),
        e.expire > 0 &&
    ...
    function a(t, i, s) {
      ...
      var d = '',
        l = !1;
      if (
        (t.width && (a.style.width = t.width),
        t.height && (a.style.height = t.height),
        t.title &&
          ((d +=
            '<div class="dhtmlx_popup_title" id="' +
            n +
            '">' +
            t.title +
            '</div>'),
      ...
      if (((d += '</div>'), (a.innerHTML = d), t.content)) {
        ...
        'string' == typeof u && (u = document.getElementById(u)),
          ...
          a.childNodes[t.title ? 1 : 0].appendChild(u);
      }
      return (
    ...
    function n(e, r, s) {
      ...
      return (
        'top' == e.position ? (n.style.top = '-3px') : (n.style.top = l + 'px'),
        (n.style.left = d + 'px'),
        (n.onkeydown = t),
    ...
    function _(e, t, i, r) {
      return (
        'object' != typeof e && (e = { text: e, type: t, expire: i, id: r }),
        (e.id = e.id || u.uid()),
    ...
    document.attachEvent
      ? document.attachEvent('onkeydown', t)
...
(dataProcessor.prototype = {
  setTransactionMode: function(e, t) {
    'object' == typeof e
      ? ((this._tMode = e.mode || this._tMode),
        void 0 !== e.headers && (this._headers = e.headers),
        void 0 !== e.payload && (this._payload = e.payload))
  ...
  markRow: function(e, t, i) {
    var r = '',
      s = this.is_invalid(e);
    if (
      (s && ((r = this.styles[s]), (t = !0)),
      this.callEvent('onRowMark', [e, t, i, s]) &&
        ((r = this.styles[t ? i : 'clear'] + r),
        this.obj[this._methods[0]](e, r),
        s && s.details))
    ) {
  ...
  sendData: function(e) {
    return !this._waitMode || ('tree' != this.obj.mytype && !this.obj._h2)
      ? (this.obj.editStop && this.obj.editStop(),
        'undefined' == typeof e || this._tSend
          ? this.sendAllData()
          : this._in_progress[e]
          ? !1
          : ((this.messages = []),
            !this.checkBeforeUpdate(e) &&
            this.callEvent('onValidationError', [e, this.messages])
              ? !1
              : void this._beforeSendData(this._getRowData(e), e)))
      : void 0;
  },
  _beforeSendData: function(e, t) {
    return this.callEvent('onBeforeUpdate', [t, this.getState(t), e])
      ? void this._sendData(e, t)
      : !1;
  },
  serialize: function(e, t) {
    ...
    for (var s in e)
      e.hasOwnProperty(s) &&
        (i.push(this.serialize_one(e[s], s + this.post_delim)), r.push(s));
    return (
      i.push('ids=' + this.escape(r.join(','))),
  ...
  _sendData: function(e, t) {
    if (e) {
      if (
        !this.callEvent(
          'onBeforeDataSending',
          t ? [t, this.getState(t), e] : [null, null, e]
        )
      )
        return !1;
      ...
      var i = this,
        r = function(r) {
          var s = [];
          if (t) s.push(t);
          else if (e) for (var a in e) s.push(a);
        ...
        a =
          ...
          (this._user
            ? s.urlSeparator(this.serverProcessor) +
              [
                'dhx_user=' + this._user,
      ...
      if ('GET' == this._tMode)
        ...
        delete l[this.action_param],
          ...
          s.query({
            ...
            headers: this._headers,
            callback: r,
            data: JSON.stringify({ id: t, action: d, data: l }),
          });
        ...
        'inserted' == h
          ...
          : 'deleted' == h
          ? ((c = 'DELETE'), (_ = _ + ('/' == _.slice(-1) ? '' : '/') + t))
          : ((c = 'PUT'),
            (l = this.serialize(e, t)),
            (_ = _ + ('/' == _.slice(-1) ? '' : '/') + t)),
          (_ = this._applyPayload(_)),
          s.query({
            url: _,
            method: c,
            headers: this._headers,
          ...
          if (!this._in_progress[this.updatedRows[t]]) {
            ...
            if (
              (this._beforeSendData(
                this._getRowData(this.updatedRows[t]),
                this.updatedRows[t]
              ),
  ...
  _getAllData: function(e) {
    for (var t = {}, i = !1, r = 0; r < this.updatedRows.length; r++) {
      ...
      if (!this._in_progress[s] && !this.is_invalid(s)) {
        ...
        this.callEvent('onBeforeUpdate', [s, this.getState(s), a]) &&
          ((t[s] = a), (i = !0), (this._in_progress[s] = new Date().valueOf()));
      }
    }
    return i ? t : null;
  },
  ...
  afterUpdateCallback: function(e, t, i, r) {
    var s = e,
      a = 'error' != i && 'invalid' != i;
    if (
      (a || this.set_invalid(e, i),
      this._uActions && this._uActions[i] && !this._uActions[i](r))
    )
    ...
    switch (i) {
      ...
      case 'insert':
        t != e &&
          (this.setUpdated(e, !1), this.obj[this._methods[2]](e, t), (e = t));
        break;
      case 'delete':
      case 'deleted':
        return (
          this.obj.setUserData(e, this.action_param, 'true_deleted'),
          this.obj[this._methods[3]](e),
          delete this._in_progress[s],
          this.callEvent('onAfterUpdate', [e, i, t, r])
        );
    }
    'wait' != this._in_progress[s]
      ? (a && this.obj.setUserData(e, this.action_param, ''),
        delete this._in_progress[s])
      : (delete this._in_progress[s],
  ...
  setAutoUpdate: function(e, t) {
    (e = e || 2e3),
      ...
      (this._need_update = !1),
      (this._update_busy = !1),
      this.attachEvent('onAfterUpdate', function(e, t, i, r) {
  ...
  getUpdates: function(e, t) {
    ...
    return this._update_busy
      ? !1
      : ((this._update_busy = !0), void i.get(e, t));
  },
  _v: function(e) {
  ...
  window.dataProcessor &&
    ...
    (dataProcessor.prototype.init = function(e) {
      this.init_original(e),
        ...
        (this.serverProcessor +=
          (-1 != this.serverProcessor.indexOf('?') ? '&' : '?') +
          'editing=true');
    })),
    ...
    dhtmlxEventable(scheduler),
      ...
      (scheduler.init = function(e, t, i) {
        (t = t || scheduler._currentDate()),
          ...
          (this._quirks7 =
            _isIE && -1 == navigator.appVersion.indexOf('MSIE 8')),
          this.get_elements(),
          this.init_templates(),
          this.set_actions(),
          this._init_once(),
      ...
      (scheduler.set_sizes = function() {
        ...
        scheduler._is_material_skin()
          ? (s ||
              ((s = document.createElement('div')),
              (s.className = 'dhx_cal_scale_placeholder'),
              this.$container.insertBefore(s, this._els.dhx_cal_header[0])),
            (s.style.display = 'block'),
            this.set_xy(
              s,
              e,
              this.xy.scale_height + 1,
              0,
              this.xy.nav_height + (this._quirks ? -1 : 1)
            ))
          : s && s.parentNode.removeChild(s),
          this.set_xy(
            this._els.dhx_cal_navline[0],
            e,
            this.xy.nav_height,
            0,
            0
        ...
        var n =
          this.xy.scale_height + this.xy.nav_height + (this._quirks ? -2 : 0);
      ...
      (scheduler.set_xy = function(e, t, i, r, s) {
        (e.style.width = Math.max(0, t) + 'px'),
          ...
          arguments.length > 3 &&
            ((e.style.left = r + 'px'), (e.style.top = s + 'px'));
      }),
      (scheduler.get_elements = function() {
        for (
          var e = this._obj.getElementsByTagName('DIV'), t = 0;
          t < e.length;
          t++
        ) {
          ...
          'string' != typeof s && r && !e[t].innerHTML && (s = r.split('_')[0]),
            s && (this._waiAria.labelAttr(e[t], s), (e[t].innerHTML = s));
        }
      }),
        ...
        (this._obj.onselectstart = function(e) {
          ...
          (this._obj.oncontextmenu = function(e) {
            var t = e || event,
              ...
              r = scheduler.callEvent('onContextMenu', [
                scheduler._locate_event(i),
                t,
              ]);
            return r;
          });
      ...
      (scheduler._click = {
        dhx_cal_data: function(e) {
          ...
          if (((e = e || event), i)) {
            if (
              !scheduler.callEvent('onClick', [i, e]) ||
              scheduler.config.readonly
            )
              return;
          } else
            scheduler.callEvent('onEmptyClick', [
              scheduler.getActionData(e).date,
              e,
            ]);
          if (i && scheduler.config.select) {
            ...
            -1 != r.indexOf('_icon') &&
              scheduler._click.buttons[r.split(' ')[1].replace('icon_', '')](i);
          } else
            scheduler._close_not_saved(),
              new Date().valueOf() - (scheduler._new_event || 0) > 500 &&
                scheduler.unselect();
        },
        ...
        dhx_cal_next_button: function(e, t) {
          scheduler.setCurrentView(
            scheduler.date.add(
              scheduler.date[scheduler._mode + '_start'](scheduler._date),
              t || 1,
              scheduler._mode
            )
          );
        ...
        dhx_cal_today_button: function() {
          scheduler.callEvent('onBeforeTodayDisplayed', []) &&
      ...
      (scheduler.addEventNow = function(e, t, i) {
        ...
        e ||
          (e =
            r.start_date ||
            Math.round(scheduler._currentDate().valueOf() / s) * s);
        var a = new Date(e);
        if (!t) {
          var n = this.config.first_hour;
          n > a.getHours() && (a.setHours(n), (e = a.valueOf())),
            (t = e.valueOf() + s);
        }
        var d = new Date(t);
        a.valueOf() == d.valueOf() && d.setTime(d.valueOf() + s),
          (r.start_date = r.start_date || a),
          (r.end_date = r.end_date || d),
          (r.text = r.text || this.locale.labels.new_event),
          (r.id = this._drag_id = r.id || this.uid()),
      ...
      (scheduler._get_column_index = function(e) {
        ...
        if (this._cols) {
          for (
            var i = 0, r = 0;
            i + this._cols[r] < e && r < this._cols.length;

          )
            (i += this._cols[r]), r++;
          if (
            ((t = r + (this._cols[r] ? (e - i) / this._cols[r] : 0)),
          ...
          return (
            ...
            (e.y =
              Math.max(
                ...
                Math.ceil(
                  (60 * e.y) /
                    (this.config.time_step * this.config.hour_size_px)
                ) - 1
              ) +
      ...
      (scheduler._mouse_coords = function(e) {
        ...
        (t =
          _isIE || (!e.pageX && !e.pageY)
            ? {
                x:
                  e.clientX +
                  (i.scrollLeft || r.scrollLeft || 0) -
                  i.clientLeft,
          ...
          (t.y -=
            this.$domHelpers.getAbsoluteTop(this._obj) +
            this.xy.nav_height +
            (this._dy_shift || 0) +
            this.xy.scale_height -
            this._els.dhx_cal_data[0].scrollTop),
          (t.ev = e);
        ...
        if (s) t = s.call(this, t);
          ...
          for (
            n = 1;
            n < this._colsS.heights.length && !(this._colsS.heights[n] > t.y);
            n++
          );
          (t.y = Math.ceil(
            (24 * (Math.max(0, a) + 7 * Math.max(0, n - 1)) * 60) /
              this.config.time_step
          )),
            (scheduler._drag_mode || 'month' == this._mode) &&
              (t.y =
                (24 *
                  (Math.max(0, Math.ceil(a) - 1) + 7 * Math.max(0, n - 1)) *
                  60) /
                this.config.time_step),
            'move' == this._drag_mode &&
              scheduler._ignores_detected &&
              scheduler.config.preserve_length &&
              ((t._ignores = !0),
      ...
      (scheduler._close_not_saved = function() {
        if (
          ...
          scheduler._dhtmlx_confirm(
            e,
            scheduler.locale.labels.title_confirm_closing,
            function() {
      ...
      (scheduler._correct_shift = function(e, t) {
        return (e -=
          6e4 *
          (new Date(scheduler._min_date).getTimezoneOffset() -
      ...
      (scheduler._is_pos_changed = function(e, t) {
        ...
        return !!(
          ...
          t.timestamp - this._drag_pos.timestamp > r ||
          i(e.ev.clientX, t.ev.clientX, s) ||
          i(e.ev.clientY, t.ev.clientY, s)
        );
      }),
      (scheduler._correct_drag_start_date = function(e) {
        var t;
        scheduler.matrix && (t = scheduler.matrix[scheduler._mode]),
          (t = t || { x_step: 1, x_unit: 'day' }),
          (e = new Date(e));
        var i = 1;
        return (
          (t._start_correction || t._end_correction) &&
            (i =
              60 * (t.last_hour || 0) - (60 * e.getHours() + e.getMinutes()) ||
              1),
      ...
      (scheduler._correct_drag_end_date = function(e, t) {
        ...
        scheduler.matrix && (i = scheduler.matrix[scheduler._mode]),
          (i = i || { x_step: 1, x_unit: 'day' });
        var r = 1 * e + scheduler._get_fictional_event_length(e, t, i);
        return new Date(
          1 * r - (scheduler._get_fictional_event_length(r, -1, i, -1) + 1)
        );
      }),
        ...
        if (this._drag_mode) {
          ...
          if (this._is_pos_changed(this._drag_pos, t)) {
            ...
            if (
              (this._drag_pos &&
                !this._drag_pos.has_moved &&
                ((s = this._drag_pos), (s.has_moved = !0)),
              (this._drag_pos = t),
              ...
              ('day' != this._mode && 'week' != this._mode) ||
                n.getHours() != d.getHours() ||
                n.getMinutes() != d.getMinutes() ||
                (d = new Date(this._drag_start + 1e3)),
            ...
            if (
              (scheduler.matrix && (l = scheduler.matrix[scheduler._mode]),
              (l = l || { x_step: 1, x_unit: 'day' }),
              'move' == this._drag_mode)
            )
              (i =
                this._min_date.valueOf() +
                6e4 *
                  (t.y * this.config.time_step +
                    24 * t.x * 60 -
                    (scheduler._move_pos_shift || 0))),
                !t.custom &&
                  this._table_view &&
                  (i += 1e3 * this.date.time_part(o.start_date)),
                (i = this._correct_shift(i)),
                t._ignores && this.config.preserve_length && this._table_view
                  ? ((i = scheduler._correct_drag_start_date(i)),
                    (r = scheduler._correct_drag_end_date(
                      i,
                      this._drag_event._event_length
                    )))
                  : (r = o.end_date.valueOf() - (o.start_date.valueOf() - i));
            else {
              if (
                ((i = o.start_date.valueOf()),
                (r = o.end_date.valueOf()),
                this._table_view)
              ) {
                var h =
                  this._min_date.valueOf() +
                  t.y * this.config.time_step * 6e4 +
                  (t.custom ? 0 : 864e5);
                if ('month' == this._mode)
                  if (
                    ((h = this._correct_shift(h, !1)), this._drag_from_start)
                  ) {
                    var _ = 864e5;
                    h <=
                      scheduler.date.date_part(new Date(r + _ - 1)).valueOf() &&
                      (i = h - _);
                  } else r = h;
                else
                  this.config.preserve_length
                    ? t.resize_from_start
                      ? (i = scheduler._correct_drag_start_date(h))
                      : (r = scheduler._correct_drag_end_date(h, 0))
                    : t.resize_from_start
                    ? (i = h)
                    : (r = h);
              } else {
                var c = this.date
                    .date_part(new Date(o.end_date.valueOf() - 1))
                    .valueOf(),
                  u = new Date(c);
                (r = c + t.y * this.config.time_step * 6e4),
                  (r +=
                    6e4 *
                    (new Date(r).getTimezoneOffset() - u.getTimezoneOffset())),
                  (this._els.dhx_cal_data[0].style.cursor = 's-resize'),
                  ('week' == this._mode || 'day' == this._mode) &&
                    (r = this._correct_shift(r));
              }
              if ('new-size' == this._drag_mode)
                if (r <= this._drag_start) {
                  var g =
                    t.shift || (this._table_view && !t.custom ? 864e5 : 0);
                  (i = r - (t.shift ? 0 : g)),
                    (r = this._drag_start + (g || 6e4 * this.config.time_step));
            ...
            if (
              'move' == this._drag_mode &&
              scheduler.config.limit_drag_out &&
              (+v < +scheduler._min_date || +r > +scheduler._max_date)
            ) {
              if (
                +o.start_date < +scheduler._min_date ||
                +o.end_date > +scheduler._max_date
              )
                (v = new Date(o.start_date)), (r = new Date(o.end_date));
              else {
                var m = r - v;
                +v < +scheduler._min_date
                  ? ((v = new Date(scheduler._min_date)),
                    t._ignores &&
                    this.config.preserve_length &&
                    this._table_view
                      ? ((v = new Date(scheduler._correct_drag_start_date(v))),
                        l._start_correction &&
                          (v = new Date(v.valueOf() + l._start_correction)),
                        (r = new Date(
                          1 * v +
                  ...
                  : ((r = new Date(scheduler._max_date)),
                    ...
                    this._table_view
                      ? (l._end_correction &&
                          (r = new Date(r.valueOf() - l._end_correction)),
                        (r = new Date(
                          1 * r - this._get_fictional_event_length(r, 0, l, !0)
                        )),
                        (v = new Date(
                          1 * r -
                            this._get_fictional_event_length(
                        ...
                        this._ignores_detected &&
                          ((v = scheduler.date.add(v, l.x_step, l.x_unit)),
                          (r = new Date(
                            1 * r -
                              this._get_fictional_event_length(r, 0, l, !0)
                          )),
                          (r = scheduler.date.add(r, l.x_step, l.x_unit))))
                      : (v = new Date(+r - m)));
              }
              var f = new Date(r - 1);
            }
            if (
              ...
              ((!scheduler._get_section_view() &&
                t.x !=
                  this._get_event_sday({
              ...
              (r = scheduler.date.date_part(new Date(_))),
                r.setHours(this.config.last_hour),
                (f = new Date(r - 1)),
                'move' == this._drag_mode && (v = new Date(+r - m));
            }
            if (
              this._table_view ||
              (f.getDate() == v.getDate() &&
                f.getHours() < this.config.last_hour) ||
              scheduler._allow_dnd
            )
              if (
                ((o.start_date = v),
                (o.end_date = new Date(r)),
                this.config.update_render)
              ) {
                var p = scheduler._els.dhx_cal_data[0].scrollTop;
                this.update_view(),
                  (scheduler._els.dhx_cal_data[0].scrollTop = p);
              } else this.updateEvent(this._drag_id);
            this._table_view &&
              this.for_rendered(this._drag_id, function(e) {
                e.className += ' dhx_in_move dhx_cal_event_drag';
              }),
              this.callEvent('onEventDrag', [
                this._drag_id,
                this._drag_mode,
                e,
              ]);
        ...
        if (2 != e.button && !this.config.readonly && !this._drag_mode) {
          ...
          switch (i) {
            ...
            case 'dhx_event_resize':
              ...
              var r = scheduler._getClassName(t);
              r.indexOf('dhx_event_resize_end') < 0
                ? (scheduler._drag_from_start = !0)
                : (scheduler._drag_from_start = !1);
              break;
            case 'dhx_scale_holder':
            case 'dhx_scale_holder_now':
            case 'dhx_month_body':
            ...
            default:
              if (
                (!scheduler.checkEvent('onMouseDown') ||
                  scheduler.callEvent('onMouseDown', [i, e])) &&
                t.parentNode &&
                t != this &&
                'dhx_body' != i
              )
          ...
          if (this._drag_mode) {
            ...
            if (
              ...
              this.callEvent('onBeforeDrag', [s, this._drag_mode, e])
            ) {
              if (
                ((this._drag_id = s),
                ...
                return;
              (this._drag_event = scheduler._lame_clone(
                this.getEvent(this._drag_id) || {}
              )),
          ...
          if (this._drag_mode && this._drag_id) {
            ...
            if (
              ...
              (this._drag_event._dhx_changed ||
                !this._drag_event.start_date ||
                s.start_date.valueOf() !=
                  this._drag_event.start_date.valueOf() ||
                s.end_date.valueOf() != this._drag_event.end_date.valueOf())
            ) {
              var a = 'new-size' == this._drag_mode;
              if (
                this.callEvent('onBeforeEventChanged', [
                  s,
                  e,
                  a,
                  this._drag_event,
                ...
                if (
                  ...
                  if (
                    ...
                    this._table_view ||
                      ...
                      !this.config.select ||
                      !this.isOneDayEvent(this.getEvent(t)))
                  )
                    return (
                  ...
                  this._new_event ||
                    this.callEvent(a ? 'onEventAdded' : 'onEventChanged', [
                      t,
                      this.getEvent(t),
                    ]);
              else
                a
                  ? this.deleteEvent(s.id, !0)
                  : ((this._drag_event._dhx_changed = !1),
                    this._clear_temporary_properties(s, this._drag_event),
                    scheduler._lame_copy(s, this._drag_event),
                    this.updateEvent(s.id));
            }
            this._drag_pos &&
              (this._drag_pos.has_moved || this._drag_pos === !0) &&
              ((this._drag_id = this._drag_mode = null),
      ...
      (scheduler._trigger_dyn_loading = function() {
        return this._load_mode && this._load()
          ? ((this._render_wait = !0), !0)
          : !1;
      }),
      ...
      (scheduler.isViewExists = function(e) {
        return !!(
          scheduler[e + '_view'] ||
          (scheduler.date[e + '_start'] &&
            scheduler.templates[e + '_date'] &&
            scheduler.templates[e + '_scale_date'])
        );
      }),
        ...
        for (
          ...
          for (var i = this._els[e[t]], r = 0; i && r < i.length; r++) {
            ...
            s && (a = this.locale.labels[s] || a),
              'dhx_cal_next_button' == e[t]
                ? (a = this.locale.labels.next)
                : 'dhx_cal_prev_button' == e[t] &&
                  (a = this.locale.labels.prev),
              this._waiAria.headerButtonsAttributes(i[r], a || '');
          }
      }),
      (scheduler.updateView = function(e, t) {
        ...
        var i = 'dhx_cal_data',
          ...
          a = 'dhx_scheduler_' + t;
        this._mode && -1 != r.className.indexOf(s)
          ? (r.className = r.className.replace(s, a))
          : (r.className += ' ' + a);
        var n,
          d = 'dhx_multi_day',
          l =
            this._mode == t && this.config.preserve_scroll
              ? this._els[i][0].scrollTop
              : !1;
        this._els[d] && this._els[d][0] && (n = this._els[d][0].scrollTop),
          this[this._mode + '_view'] &&
            t &&
            this._mode != t &&
            this[this._mode + '_view'](!1),
          this._close_not_saved(),
          this._els[d] &&
            (this._els[d][0].parentNode.removeChild(this._els[d][0]),
            (this._els[d] = null)),
          (this._mode = t),
          (this._date = e),
        ...
        if (o)
          for (var h = 0; h < o.length; h++) {
            ...
            (c = c.replace(/ active/g, '')),
              _.getAttribute('name') == this._mode + '_tab'
                ? ((c += ' active'), this._waiAria.headerToggleState(_, !0))
                : this._waiAria.headerToggleState(_, !1),
              (_.className = c);
          }
        this.update_view(),
          'number' == typeof l && (this._els[i][0].scrollTop = l),
          'number' == typeof n &&
            this._els[d] &&
            this._els[d][0] &&
            (this._els[d][0].scrollTop = n);
      }),
      (scheduler.setCurrentView = function(e, t) {
        this.callEvent('onBeforeViewChange', [
          this._mode,
          this._date,
          t || this._mode,
          e || this._date,
      ...
      (scheduler._render_x_header = function(e, t, i, r, s) {
        ...
        (a.className = 'dhx_scale_bar'),
          this.templates[this._mode + '_scalex_class'] &&
            (a.className +=
              ' ' + this.templates[this._mode + '_scalex_class'](i));
        var n = this._cols[e] - 1;
        'month' == this._mode &&
          0 === e &&
          this.config.left_border &&
          ((a.className += ' dhx_scale_bar_border'), (t += 1)),
          this.set_xy(a, n, this.xy.scale_height - 2, t, s);
      ...
      (scheduler._calc_scale_sizes = function(e, t, i) {
        ...
        for (var a = s - this._ignores_detected, n = 0; s > n; n++)
          this._ignores[n]
            ? ((this._cols[n] = 0), a++)
            : (this._cols[n] = Math.floor(r / (a - n))),
            (r -= this._cols[n]),
            (this._colsS[n] =
              (this._cols[n - 1] || 0) +
              (this._colsS[n - 1] ||
                (this._table_view ? 0 : this.xy.scale_width + 2)));
        (this._colsS.col_length = s),
          (this._colsS[s] = this._cols[s - 1] + this._colsS[s - 1] || 0);
      }),
      (scheduler._set_scale_col_size = function(e, t, i) {
        ...
        this.set_xy(
          e,
          t - 1,
          r.hour_size_px * (r.last_hour - r.first_hour),
      ...
      (scheduler._render_scales = function(e, t) {
        ...
        for (var o = 0; d > o; o++) {
          if (
            (this._ignores[o] || this._render_x_header(o, l, n, e),
            !this._table_view)
          ) {
            var h = document.createElement('div'),
              _ = 'dhx_scale_holder';
            n.valueOf() == s.valueOf() && (_ = 'dhx_scale_holder_now'),
              this._ignores_detected &&
                this._ignores[o] &&
                (_ += ' dhx_scale_ignore'),
              (h.className = _ + ' ' + this.templates.week_date_class(n, s)),
              this._waiAria.dayColumnAttr(h, n),
              this._set_scale_col_size(h, this._cols[o], l),
              t.appendChild(h),
              this.callEvent('onScaleAdd', [h, n]);
          }
          (l += this._cols[o]),
            (n = this.date.add(n, 1, 'day')),
            (n = this.date.day_start(n));
        }
      }),
      (scheduler._reset_scale = function() {
        if (this.templates[this._mode + '_date']) {
          ...
          (s = a = this._table_view ? scheduler.date.week_start(n) : n),
            (this._min_date = s);
          var l = this.templates[this._mode + '_date'](n, d, this._mode);
          if (
            ((this._els.dhx_cal_date[0].innerHTML = l),
            this._waiAria.navBarDateAttr(this._els.dhx_cal_date[0], l),
            (this._max_date = d),
            scheduler._render_scales(e, t),
            this._table_view)
          )
            this._reset_month_scale(t, n, a);
          else if ((this._reset_hours_scale(t, n, a), i.multi_day)) {
            var o = 'dhx_multi_day';
            this._els[o] &&
              (this._els[o][0].parentNode.removeChild(this._els[o][0]),
              (this._els[o] = null));
            ...
            (c.className = o),
              ...
              this.set_xy(
                c,
                Math.max(
                  this._colsS[this._colsS.col_length] +
            ...
            (u.className = o + '_icon'),
              ...
              this.set_xy(u, this.xy.scale_width, 0, 0, _),
              c.appendChild(u),
              (this._els[o] = [c, u]),
      ...
      (scheduler._reset_hours_scale = function(e, t, i) {
        ...
        for (
          var s = new Date(1980, 1, 1, this.config.first_hour, 0, 0),
            a = 1 * this.config.first_hour;
          a < this.config.last_hour;
          a++
        ) {
          var n = document.createElement('div');
          (n.className = 'dhx_scale_hour'),
            (n.style.height = this.config.hour_size_px + 'px');
          var d = this.xy.scale_width;
          this.config.left_border && (n.className += ' dhx_scale_hour_border'),
            (n.style.width = d + 'px');
          var l = scheduler.templates.hour_scale(s);
          (n.innerHTML = l),
            this._waiAria.hourScaleAttr(n, l),
            r.appendChild(n),
            (s = this.date.add(s, 1, 'hour'));
        }
        e.appendChild(r),
      ...
      (scheduler._currentDate = function() {
        return scheduler.config.now_date
          ? new Date(scheduler.config.now_date)
          : new Date();
      }),
        ...
        if (a)
          for (var n = new Date(e), d = 0; t > d; d++)
            a(n) &&
              ...
              (this._ignores[d] = !0),
              s && t++),
              (n = scheduler.date.add(n, r, i)),
              scheduler.date[i + '_start'] &&
                (n = scheduler.date[i + '_start'](n));
      }),
      (scheduler._render_month_scale = function(e, t, i, r) {
        function s(e) {
          var t = scheduler._colsS.height;
          return (
            void 0 !== scheduler._colsS.heights[e + 1] &&
              (t =
                scheduler._colsS.heights[e + 1] -
                (scheduler._colsS.heights[e] || 0)),
            t
          );
        }
        ...
        this.date.date_part(d),
          ...
          (r =
            r ||
            Math.ceil(Math.round((a.valueOf() - i.valueOf()) / 864e5) / 7));
        for (var l = [], o = 0; 7 >= o; o++) {
        ...
        for (var g = [], o = 0; r > o; o++) {
          ...
          u.appendChild(f);
          for (
            var v = Math.max(s(o) - scheduler.xy.month_head_height, 0), m = 0;
            7 > m;
            m++
          ) {
            ...
            t > i
              ...
              : i >= a
              ? (x = 'dhx_after')
              : i.valueOf() == d.valueOf() && (x = 'dhx_now'),
              this._ignores_detected &&
                this._ignores[m] &&
                (x += ' dhx_scale_ignore'),
              (p.className = x + ' ' + this.templates.month_date_class(i, d));
            var b = 'dhx_month_body',
              y = 'dhx_month_head';
            if (
              (0 === m &&
                this.config.left_border &&
                ((b += ' dhx_month_body_border'),
            ...
            (i = this.date.add(i, 1, 'day')),
              i.getDate() - E > 1 &&
                (i = new Date(i.getFullYear(), i.getMonth(), E + 1, 12, 0));
          }
      ...
      (scheduler._reset_month_scale = function(e, t, i, r) {
        ...
        this.date.date_part(a),
          ...
          (r =
            r ||
            Math.ceil(Math.round((s.valueOf() - i.valueOf()) / 864e5) / 7));
        var n = Math.floor(e.clientHeight / r) - this.xy.month_head_height;
        return (
          (this._colsS.height = n + this.xy.month_head_height),
          (this._colsS.heights = []),
      ...
      (scheduler._lame_clone = function(e, t) {
        ...
        if (e && 'object' == typeof e) {
          for (
            s = {}, r = [Array, Date, Number, String, Boolean], i = 0;
            i < r.length;
            i++
          )
          ...
          t.push(e, s);
          for (i in e)
            Object.prototype.hasOwnProperty.apply(e, [i]) &&
              (s[i] = scheduler._lame_clone(e[i], t));
        }
        return s || e;
      }),
      ...
      (scheduler._get_date_from_pos = function(e) {
        var t =
          this._min_date.valueOf() +
          6e4 *
            (e.y * this.config.time_step +
              24 * (this._table_view ? 0 : e.x) * 60);
      ...
      (scheduler._get_real_event_length = function(e, t, i) {
        var r,
          ...
          d = 0;
        i.render
          ? ((d = this._get_date_index(i, e)), (r = this._get_date_index(i, t)))
          : (r = Math.round(s / 60 / 60 / 1e3 / 24));
        for (var l = !0; r > d; ) {
      ...
      (scheduler._get_fictional_event_length = function(e, t, i, r) {
        ...
        if (i._start_correction || i._end_correction) {
          var n;
          n = r
            ? 60 * s.getHours() + s.getMinutes() - 60 * (i.first_hour || 0)
            : 60 * (i.last_hour || 0) - (60 * s.getHours() + s.getMinutes());
        ...
        for (
          i.render
            ? ((c = this._get_date_index(i, s)),
              (o = this._get_date_index(i, h)))
            : (o = Math.round(t / 60 / 60 / 1e3 / 24));
          o * a >= c * a;
      ...
      (scheduler.eventRemove = function(e, t, i) {
        e.removeEventListener
          ? e.removeEventListener(t, i, !1)
          : e.detachEvent && e.detachEvent('on' + t, i);
      }),
      (function() {
        function e(e) {
          ...
          if (window.getComputedStyle) {
            ...
            e.currentStyle &&
              ((t = e.currentStyle.display), (i = e.currentStyle.visibility));
          var s = !1,
        ...
        function t(e) {
          return (
            !isNaN(e.getAttribute('tabindex')) &&
            1 * e.getAttribute('tabindex') >= 0
          );
        }
        function i(e) {
          var t = { a: !0, area: !0 };
      ...
      (function() {
        ...
        scheduler._waiAria = {
          ...
          _eventCommonAttr: function(t, i) {
            i.setAttribute(
              'aria-label',
              e(scheduler.templates.tooltip_text(t.start_date, t.end_date, t))
            ),
              scheduler.config.readonly && i.setAttribute('aria-readonly', !0),
              t.$dataprocessor_class && i.setAttribute('aria-busy', !0),
              i.setAttribute(
                'aria-selected',
                scheduler.getState().select_id == t.id ? 'true' : 'false'
              );
          },
          ...
          eventBarAttrString: function(e) {
            return this.getAttributeString(
              this._getAttributes(this.setEventBarAttr, e)
            );
          },
          ...
          minicalDayCell: function(e, t) {
            var i =
              t.valueOf() < scheduler._max_date.valueOf() &&
              t.valueOf() >= scheduler._min_date.valueOf();
            this.setAttributes(e, {
              role: 'gridcell',
          ...
          weekAgendaDayCell: function(e, t) {
            ...
            this.setAttributes(i, { id: s }),
              this.setAttributes(r, { 'aria-labelledby': s });
          },
          ...
          lightboxSelectAttrString: function(e) {
            ...
            switch (e) {
              ...
              case '%H:%i':
                t =
                  scheduler.locale.labels.hour +
                  ' ' +
                  scheduler.locale.labels.minute;
            }
      ...
      (scheduler.$env = {
        ...
        isIE6:
          !window.XMLHttpRequest && navigator.userAgent.indexOf('MSIE') >= 0,
        isIE7:
      ...
      (scheduler.$ajax = {
        ...
        parse: function(e) {
          ...
          return (
            (e = e.replace(/^[\s]+/, '')),
            window.DOMParser && !scheduler.$env.isIE
        ...
        xmltop: function(e, t, i) {
          ...
          return (
            -1 !== i &&
              this._obj.callEvent('onLoadXMLError', [
                'Incorrect XML',
                arguments[1],
                i,
              ]),
        ...
        xpath: function(e, t) {
          if ((t.nodeName || (t = t.responseXML || t), scheduler.$env.isIE))
            return t.selectNodes(e) || [];
          for (
            var i,
              r = [],
              s = (t.ownerDocument || t).evaluate(
                e,
                t,
                null,
        ...
        post: function(e, t, i) {
          1 == arguments.length
            ? (t = '')
            : 2 != arguments.length ||
              ('function' != typeof t && 'function' != typeof window[t])
            ? (t = String(t))
            : ((i = t), (t = '')),
            this._call('POST', e, t, !0, i);
        },
        postSync: function(e, t) {
          return (
            (t = null === t ? '' : String(t)), this._call('POST', e, t, !1)
          );
        },
        ...
        postLong: function(e, t, i) {
          2 == arguments.length && ((i = t), (t = '')),
            this._call('POST', e, t, !0, i, { url: e, postData: t });
        },
        _call: function(e, t, i, r, s, a, n) {
          var d = this._obj,
            l =
              window.XMLHttpRequest && !d.$env.isIE
                ? new XMLHttpRequest()
            ...
            (r &&
              (l.onreadystatechange = function() {
                if (4 == l.readyState || (o && 3 == l.readyState)) {
                  if (
                    (200 != l.status || '' === l.responseText) &&
                    !d.callEvent('onAjaxError', [l])
                  )
                    return;
                  window.setTimeout(function() {
                    'function' == typeof s &&
                      s.apply(window, [{ xmlDoc: l, filePath: t }]),
                      a &&
                        ('undefined' != typeof a.postData
                          ? this.postLong(a.url, a.postData, s)
                          : this.getLong(a.url, s)),
                      (s = null),
                      (l = null);
                  }, 1);
                }
      ...
      (scheduler.date = {
        init: function() {
          for (
            var e = scheduler.locale.date.month_short,
            ...
            t[e[i]] = i;
          for (
            var e = scheduler.locale.date.month_full,
        ...
        date_part: function(e) {
          ...
          return (
            ...
            e.getHours() &&
              ...
              e.setTime(e.getTime() + 36e5 * (24 - e.getHours())),
            e
          );
        },
        ...
        week_start: function(e) {
          var t = e.getDay();
          return (
            scheduler.config.start_on_monday && (0 === t ? (t = 6) : t--),
        ...
        str_to_date: function(e, t) {
          for (
            var i = 'var temp=date.match(/[a-zA-Z]+|[0-9]+/g);',
              r = e.match(/%[a-zA-Z]/g),
              s = 0;
            s < r.length;
            s++
            ...
            switch (r[s]) {
              ...
              case '%M':
                i +=
                  'set[1]=this.locale.date.month_short_hash[temp[' +
                  s +
                  ']]||0;';
                break;
              case '%F':
                i +=
                  'set[1]=this.locale.date.month_full_hash[temp[' +
                  s +
                  ']]||0;';
            }
          ...
          var n = new Function(
            'date',
            'var set=[0,0,1,0,0,0]; ' + i + ' return new Date(' + a + ');'
          );
      ...
      (scheduler.init_templates = function() {
        ...
        r(scheduler.templates, {
          ...
          week_date: function(e, t) {
            return (
              scheduler.templates.day_date(e) +
              ' &ndash; ' +
              scheduler.templates.day_date(scheduler.date.add(t, -1, 'day'))
            );
          },
          ...
          event_header: function(e, t, i) {
            return (
              scheduler.templates.event_date(e) +
              ' - ' +
              scheduler.templates.event_date(t)
            );
          },
          ...
          tooltip_text: function(e, t, i) {
            return (
              ...
              i.text +
              '<br/><b>Start date:</b> ' +
              scheduler.templates.tooltip_date_format(e) +
              '<br/><b>End date:</b> ' +
              scheduler.templates.tooltip_date_format(t)
            );
          },
        }),
      ...
      (scheduler.addEvent = function(e, t, i, r, s) {
        ...
        1 != arguments.length &&
          ...
          (a.text = i),
          (a.id = r)),
          (a.id = a.id || scheduler.uid()),
          (a.text = a.text || ''),
          'string' == typeof a.start_date &&
            (a.start_date = this.templates.api_date(a.start_date)),
          'string' == typeof a.end_date &&
            (a.end_date = this.templates.api_date(a.end_date));
        var n = 6e4 * (this.config.event_duration || this.config.time_step);
        a.start_date.valueOf() == a.end_date.valueOf() &&
          a.end_date.setTime(a.end_date.valueOf() + n),
          (a._timed = this.isOneDayEvent(a));
        var d = !this._events[a.id];
        return (
          (this._events[a.id] = a),
          this.event_updated(a),
          this._loading ||
            this.callEvent(d ? 'onEventAdded' : 'onEventChanged', [a.id, a]),
          a.id
        );
      }),
      (scheduler.deleteEvent = function(e, t) {
        ...
        (t ||
          (this.callEvent('onBeforeEventDelete', [e, i]) &&
            this.callEvent('onConfirmedBeforeEventDelete', [e, i]))) &&
          (i &&
            ((this._select_id = null),
      ...
      (scheduler.for_rendered = function(e, t) {
        for (var i = this._rendered.length - 1; i >= 0; i--)
          this._rendered[i].getAttribute('event_id') == e &&
            t(this._rendered[i], i);
      }),
      ...
      (function() {
        for (
          ...
          (scheduler['getEvent' + e[r + 1]] = t(e[r])),
            (scheduler['setEvent' + e[r + 1]] = i(e[r]));
      })(),
      (scheduler.event_updated = function(e, t) {
        this.is_visible_events(e)
          ? this.render_view_data()
          : this.clear_event(e.id);
      }),
      (scheduler.is_visible_events = function(e) {
        var t =
          e.start_date.valueOf() < this._max_date.valueOf() &&
          this._min_date.valueOf() < e.end_date.valueOf();
        if (t) {
      ...
      (scheduler.isOneDayEvent = function(e) {
        ...
        return t
          ? (0 > t &&
              (t = Math.ceil(
                (e.end_date.valueOf() - e.start_date.valueOf()) / 864e5
              )),
            1 == t &&
              !e.end_date.getHours() &&
              !e.end_date.getMinutes() &&
              (e.start_date.getHours() || e.start_date.getMinutes()))
          : e.start_date.getMonth() == e.end_date.getMonth() &&
      ...
      (scheduler.get_visible_events = function(e) {
        ...
        for (var i in this._events)
          this.is_visible_events(this._events[i]) &&
            (!e || this._events[i]._timed) &&
            this.filter_event(i, this._events[i]) &&
            t.push(this._events[i]);
        return t;
      }),
      ...
      (scheduler.render_view_data = function(e, t) {
        ...
        if (!e) {
          ...
          (this._render_wait = !1),
            this.clear_view(),
            (e = this.get_visible_events(
              !(this._table_view || this.config.multi_day)
            ));
        }
      ...
      (scheduler._view_month_day = function(e) {
        ...
        scheduler.callEvent('onViewMoreClick', [t]) &&
          scheduler.setCurrentView(t, 'day');
      }),
      (scheduler._render_month_link = function(e) {
        for (
          var t = this._rendered_location, i = this._lame_clone(e), r = e._sday;
          r < e._eday;
          r++
        ) {
          ...
          (o.onclick = function(e) {
            ...
            (o.className = 'dhx_month_link'),
            (o.style.top = d.y + 'px'),
            (o.style.left = d.x + 'px'),
            (o.style.width = l + 'px'),
            (o.innerHTML = scheduler.templates.month_events_link(a, n)),
          ...
          if (this._table_view)
            if ('month' != scheduler._mode) this.render_event_bar(e[i]);
              ...
              r !== 1 * r || e[i]._sorder < r
                ...
                : void 0 !== r &&
                  e[i]._sorder == r &&
                  scheduler._render_month_link(e[i]);
            }
      ...
      (scheduler._pre_render_events = function(e, t) {
        ...
        if (
          ((e = this._table_view
            ? this._pre_render_events_table(e, t)
            : this._pre_render_events_line(e, t)),
          this._table_view)
        )
          if (t) this._colsS.heights = r;
            ...
            if (n.rows) {
              for (var d = 0; d < n.rows.length; d++) {
                ...
                if (s[d] * i > o) {
                  var h = o;
                  1 * this.config.max_month_events !==
                    this.config.max_month_events ||
                  s[d] <= this.config.max_month_events
                    ? (h = s[d] * i)
                    : (this.config.max_month_events + 1) * i > o &&
                      (h = (this.config.max_month_events + 1) * i);
                  for (var _ = 0; _ < l.length; _++)
                    l[_].childNodes[1].style.height = h + 'px';
                }
                s[d] =
                  (s[d - 1] || 0) +
                  scheduler._get_first_visible_cell(l).offsetHeight;
              }
              if (
                (s.unshift(0),
                n.parentNode.offsetHeight < n.parentNode.scrollHeight &&
                  !scheduler._colsS.scroll_fix &&
              ...
              (e.length ||
                'visible' != this._els.dhx_multi_day[0].style.visibility ||
                (s[0] = -1),
              e.length || -1 == s[0])
            ) {
              ...
              (p.style.height = m),
                (p.style.visibility = -1 == s[0] ? 'hidden' : 'visible');
              var x = this._els.dhx_multi_day[1];
              (x.style.height = m),
                (x.style.visibility = -1 == s[0] ? 'hidden' : 'visible'),
                (x.className = s[0]
                  ? 'dhx_multi_day_icon'
                  : 'dhx_multi_day_icon_small'),
                (this._dy_shift = (s[0] + 1) * i),
                this.config.multi_day_height_limit &&
                  (this._dy_shift = Math.min(
                    this.config.multi_day_height_limit,
                    this._dy_shift
                  )),
                (s[0] = 0),
                v != f &&
                  ((a.style.top = parseInt(a.style.top) + 2 + 'px'),
      ...
      (scheduler._get_event_mapped_end_date = function(e) {
        ...
        if (this.config.separate_short_events) {
          ...
          i < this._min_mapped_duration &&
            (t = this.date.add(t, this._min_mapped_duration - i, 'minute'));
        }
        return t;
      }),
      (scheduler._pre_render_events_line = function(e, t) {
        ...
        var i = [],
          r = [];
        this._min_mapped_duration = Math.ceil(
          (60 * this.xy.min_event_height) / this.config.hour_size_px
        );
        for (var s = 0; s < e.length; s++) {
          ...
          if (((a._sday = this._get_event_sday(a)), this._ignores[a._sday]))
            ...
            if ((i[a._sday] || (i[a._sday] = []), !t)) {
              ...
              h.splice(u, u == h.length ? 0 : 1, a),
                h.length > (h.max_count || 0)
                  ? ((h.max_count = h.length), (a._count = h.length))
                  : (a._count = a._count ? a._count : 1);
            }
            (l < this.config.first_hour || o >= this.config.last_hour) &&
              (r.push(a),
              (e[s] = a = this._copy_event(a)),
              l < this.config.first_hour &&
                (a.start_date.setHours(this.config.first_hour),
                a.start_date.setMinutes(0)),
              o >= this.config.last_hour &&
                (a.end_date.setMinutes(0),
                a.end_date.setHours(this.config.last_hour)),
              a.start_date > a.end_date || l == this.config.last_hour) &&
              (e.splice(s, 1), s--);
          }
        }
        if (!t) {
        ...
        for (
          ...
          if (((o._sday = g % n), !this._ignores[o._sday] || !o._timed)) {
            ...
            (o._eday = f % n || n),
              (o._length = f - g),
              (o._sweek = Math.floor(
                (this._correct_shift(c.valueOf(), 1) -
                  this._min_date.valueOf()) /
                  (864e5 * n)
              ));
            var v,
            ...
            if (((o._sorder && t) || (o._sorder = v), o._sday + o._length <= n))
              (i = null),
                r.push(o),
                (m[v] = o),
                (a[o._sweek] = m.length - 1),
                (o._first_chunk = _.first_chunk),
      ...
      (scheduler.updateEvent = function(e) {
        ...
        this.clear_event(e),
          t &&
            ...
            (this.config.update_render
              ? this.render_view_data()
              : 'month' != this.getState().mode ||
                this.getState().drag_id ||
                this.isOneDayEvent(t)
              ? this.render_view_data([t], !0)
              : this.render_view_data());
      }),
      ...
      (scheduler._y_from_date = function(e) {
        ...
        return (
          Math.round(
            ((60 * t * 1e3 - 60 * this.config.first_hour * 60 * 1e3) *
              this.config.hour_size_px) /
              36e5
          ) %
      ...
      (scheduler._calc_event_y = function(e, t) {
        ...
        var i = 60 * e.start_date.getHours() + e.start_date.getMinutes(),
          r =
            60 * e.end_date.getHours() + e.end_date.getMinutes() ||
            60 * scheduler.config.last_hour,
        ...
        if (!(e._sday < 0)) {
          ...
          if (r) {
            ...
            var g = this._render_v_bar(
              ...
              n,
              e._text_style,
              scheduler.templates.event_header(e.start_date, e.end_date, e),
              scheduler.templates.event_text(e.start_date, e.end_date, e)
            );
            if (
              (this._waiAria.eventAttr(e, g),
              this._rendered.push(g),
              r.appendChild(g),
              (h = h + parseInt(r.style.left, 10) + i),
              this._edit_id == e.id)
            ) {
              (g.style.zIndex = 1),
                (o = Math.max(o - 4, scheduler.xy.editor_width)),
                ...
                this.set_xy(
                  ...
                  n - 20,
                  h,
                  a + (scheduler.xy.event_header_height || 14)
                ),
                (g.className = 'dhx_cal_event dhx_cal_editor'),
                e.color && (g.style.backgroundColor = e.color);
              var f = scheduler.templates.event_class(
                e.start_date,
                e.end_date,
                e
              );
              ...
              this.set_xy(v, o - 6, n - 26),
                (v.style.cssText += ';margin:2px 2px 2px 2px;overflow:hidden;'),
                g.appendChild(v),
                this._els.dhx_cal_data[0].appendChild(g),
                this._rendered.push(g),
                (v.innerHTML =
                  "<textarea class='dhx_cal_editor'>" + e.text + '</textarea>'),
                this._quirks7 && (v.firstChild.style.height = n - 12 + 'px'),
            ...
            if (0 !== this.xy.menu_width && this._select_id == e.id) {
              ...
              for (
                var m,
                  p = this.config[
                    'icons_' + (this._edit_id == e.id ? 'edit' : 'select')
                  ],
                  x = '',
                  b = e.color ? 'background-color: ' + e.color + ';' : '',
                  y = e.textColor ? 'color: ' + e.textColor + ';' : '',
                  w = 0;
                w < p.length;
                w++
              )
                (m = this._waiAria.eventMenuAttrString(p[w])),
                  (x +=
                    ...
                    y +
                    "' title='" +
                    this.locale.labels[p[w]] +
                    "'" +
                    m +
                    '></div>');
              var D = this._render_v_bar(
                e,
                h - t + 1,
                a,
                t,
                20 * p.length + 26 - 2,
                '',
                "<div style='" + b + y + "' class='dhx_menu_head'></div>",
                x,
                !0
              );
              (D.style.left = h - t + 1),
            ...
            this.config.drag_highlight &&
              this._drag_id == e.id &&
              this.highlightEventPosition(e);
          }
        }
      }),
      (scheduler._render_v_bar = function(e, t, i, r, s, a, n, d, l) {
        ...
        c.drag_id == e.id && (_ += ' dhx_cal_event_drag'),
          c.select_id == e.id && (_ += ' dhx_cal_event_selected');
        var u = scheduler.templates.event_class(e.start_date, e.end_date, e);
        u && (_ = _ + ' ' + u),
          this.config.cascade_event_display && (_ += ' dhx_cal_event_cascade');
        var g = e.color ? 'background-color:' + e.color + ';' : '',
          ...
          y = v ? m - 2 : r - 8,
          w = v
            ? s - this.xy.event_header_height - 1
            : s - (this._quirks ? 20 : 30) + 1,
          D =
            '<div event_id="' +
            h +
            '" class="' +
        ...
        E = o.firstChild;
        var A =
          '<div class="dhx_event_move dhx_header" style=" width:' +
          x +
          'px;' +
          g +
          '" >&nbsp;</div>';
        (A +=
          '<div class="dhx_event_move dhx_title" style="' +
          g +
          f +
          '">' +
          n +
      ...
      (scheduler.locate_holder = function(e) {
        return 'day' == this._mode
          ...
          : this._els.dhx_cal_data[0].childNodes[e];
      }),
      (scheduler.locate_holder_day = function(e, t) {
        var i = Math.floor(
          (this._correct_shift(e, 1) - this._min_date) / 864e5
        );
      ...
      (scheduler._get_event_bar_pos = function(e) {
        ...
        if (e.id == this._drag_id) {
          var a =
            this._colsS.heights[e._sweek + 1] -
            this._colsS.heights[e._sweek] -
            this.xy.month_head_height;
      ...
      (scheduler.render_event_bar = function(e) {
        ...
        if (a) {
          var d =
              scheduler.config.resize_month_events &&
              'month' == this._mode &&
              (!e._timed || scheduler.config.resize_month_timed),
          ...
          (!e._timed || d) && (u = 'dhx_cal_event_line'),
            o && (u += ' dhx_cal_event_line_start'),
            h && (u += ' dhx_cal_event_line_end'),
            _ &&
              (n +=
                "<div class='dhx_event_resize dhx_event_resize_start'></div>"),
            c &&
              (n +=
                "<div class='dhx_event_resize dhx_event_resize_end'></div>");
          ...
          var f = e.color ? 'background:' + e.color + ';' : '',
            ...
            p =
              ...
              m +
              "'" +
              this._waiAria.eventBarAttrString(e) +
              '>';
          d && (p += n),
            'month' == scheduler.getState().mode &&
              (e = scheduler.getEvent(e.id)),
            e._timed &&
              (p += scheduler.templates.event_bar_date(
                e.start_date,
                e.end_date,
                e
              )),
            (p +=
              scheduler.templates.event_bar_text(e.start_date, e.end_date, e) +
              '</div>'),
            (p += '</div>'),
            (l.innerHTML = p),
          ...
          if ((s = scheduler._getClassName(r))) {
            ...
            if (a >= 0) {
              ...
              var n = 0 === a || !scheduler._trim(s.charAt(a - 1)),
                d =
                  a + t.length >= s.length ||
                  !scheduler._trim(s.charAt(a + t.length));
              if (n && d) return r;
            }
          }
          r = r.parentNode;
      ...
      (scheduler._edit_stop_event = function(e, t) {
        this._new_event
          ? (t
              ? this.callEvent('onEventAdded', [e.id, e])
              : e && this.deleteEvent(e.id, !0),
            (this._new_event = null))
          : t && this.callEvent('onEventChanged', [e.id, e]);
      }),
      (scheduler.getEvents = function(e, t) {
        ...
        for (var r in this._events) {
          ...
          s &&
            ((!e && !t) || (s.start_date < t && s.end_date > e)) &&
            i.push(s);
        }
        return i;
      }),
      ...
      (scheduler.showEvent = function(e, t) {
        ...
        if (
          ...
          if (
            ...
            (i.color = a),
            (i.textColor = n),
            (scheduler.config.scroll_hour = r),
            (scheduler.config.preserve_scroll = s),
            scheduler.matrix && scheduler.matrix[t])
          ) {
            var d = scheduler.getRenderedEvent(i.id);
            d &&
              (scheduler._els.dhx_cal_data[0].scrollTop =
                scheduler.$domHelpers.getAbsoluteTop(d) -
                scheduler.$domHelpers.getAbsoluteTop(
                  scheduler._els.dhx_cal_data[0]
                ) -
                20);
          }
      ...
      (scheduler._append_drag_marker = function(e) {
        if (!e.parentNode) {
          ...
          r.indexOf('dhx_scale_holder') < 0 &&
            i.previousSibling &&
            (i = i.previousSibling),
            (r = scheduler._getClassName(i)),
            i && 0 === r.indexOf('dhx_scale_holder') && i.appendChild(e);
        }
      }),
      ...
      (scheduler._load = function(e, t) {
        if ((e = e || this._load_url)) {
          ...
          if (((t = t || this._date), this._load_mode)) {
            ...
            for (
              t = this.date[this._load_mode + '_start'](new Date(t.valueOf()));
              t > this._min_date;
            ...
            for (var s = !0; i < this._max_date; )
              (i = this.date.add(i, 1, this._load_mode)),
                this._loaded[r(t)] && s
                  ...
                  : (s = !1);
            var a = i;
            do (i = a), (a = this.date.add(i, -1, this._load_mode));
            while (a > t && this._loaded[r(a)]);
            if (t >= i) return !1;
            for (
              scheduler.$ajax.get(e + '&from=' + r(t) + '&to=' + r(i), function(
                e
              ) {
                scheduler.on_load(e);
              });
            ...
            scheduler.$ajax.get(e, function(e) {
              scheduler.on_load(e);
            });
      ...
      (scheduler.on_load = function(e) {
        ...
        (i || (e.xmlDoc.status && e.xmlDoc.status >= 400)) &&
          (this.callEvent('onLoadError', [e.xmlDoc]), (t = [])),
      ...
      (scheduler._init_date = function(e) {
        return e
          ? 'string' == typeof e
            ? scheduler.templates.xml_date(e)
            : new Date(e)
          : null;
      }),
      (scheduler.json = {}),
      (scheduler.json.parse = function(data) {
        'string' == typeof data &&
          ...
          (data = scheduler._temp
            ? scheduler._temp.data || scheduler._temp.d || scheduler._temp
            : [])),
          data.dhx_security && (dhtmlx.security_key = data.dhx_security);
        var collections =
            scheduler._temp && scheduler._temp.collections
              ? scheduler._temp.collections
              : {},
          ...
          if (collections.hasOwnProperty(key)) {
            ...
            for (var j = 0; j < collection.length; j++) {
              var option = collection[j],
                obj = { key: option.value, label: option.label };
      ...
      (scheduler.serverList = function(e, t) {
        return t
          ? ((this.serverList[e] = t.slice(0)), this.serverList[e])
      ...
      (scheduler._magic_parser = function(e) {
        var t;
        if (
          (e.getXMLTopNode || (e = scheduler.$ajax.parse(e)),
          (t = scheduler.$ajax.xmltop('data', e.xmlDoc)),
          'data' != t.tagName)
        )
          return null;
        ...
        for (
          var r = scheduler.$ajax.xpath('//coll_options', e.xmlDoc), s = 0;
          s < r.length;
          s++
        ) {
          ...
          if (n) {
            n.splice(0, n.length);
            for (
              var d = scheduler.$ajax.xpath('.//item', r[s]), l = 0;
              l < d.length;
              l++
            ) {
              for (
        ...
        for (
          var g = scheduler.$ajax.xpath('//userdata', e.xmlDoc), s = 0;
          s < g.length;
          s++
        ) {
      ...
      (scheduler._xmlNodeToJSON = function(e) {
        ...
        for (var i = 0; i < e.childNodes.length; i++) {
          ...
          1 == r.nodeType &&
            (t[r.tagName] = r.firstChild ? r.firstChild.nodeValue : '');
        }
        return (
          t.text || (t.text = e.firstChild ? e.firstChild.nodeValue : ''), t
        );
      }),
      ...
      scheduler.attachEvent('onXLE', function() {
        ...
        e &&
          'object' == typeof e &&
          (this._obj.removeChild(e), (this.config.show_loading = !0));
      }),
      (scheduler.ical = {
        parse: function(e) {
        ...
        parse_param: function(e, t) {
          ...
          if (-1 != i) {
            ...
            'summary' == r
              ? (r = 'text')
              : 'dtstart' == r
              ? ((r = 'start_date'), (s = this.parse_date(s, 0, 0)))
              : 'dtend' == r &&
                ((r = 'end_date'), (s = this.parse_date(s, 0, 0))),
              (t[r] = s);
          }
        },
        parse_date: function(e, t, i) {
          ...
          var a = r[0].substr(0, 4),
            ...
            d = r[0].substr(6, 2);
          return scheduler.config.server_utc || s
            ? new Date(Date.UTC(a, n, d, t, i))
            : new Date(a, n, d, t, i);
        },
      ...
      (scheduler.form_blocks = {
        ...
        select: {
          render: function(e) {
            for (
              var t = scheduler._lightbox_controls.defaults.select,
                i = t ? t.height : 23,
                r = (e.height || i || '23') + 'px',
                s =
                  "<div class='dhx_cal_ltext' style='height:" +
          ...
          set_value: function(e, t, i, r) {
            ...
            !s._dhx_onchange &&
              r.onchange &&
              ((s.onchange = r.onchange), (s._dhx_onchange = !0)),
              'undefined' == typeof t && (t = (s.options[0] || {}).value),
              (s.value = t || '');
          },
          get_value: function(e, t) {
        ...
        time: {
          render: function(e) {
            ...
            var t = e.time_format,
              ...
              s = 1440,
              a = 0;
            scheduler.config.limit_time_select &&
              ((s = 60 * i.last_hour + 1),
              (a = 60 * i.first_hour),
              r.setHours(i.first_hour));
                ...
                case '%m':
                  ...
                  for (var c = 0; 12 > c; c++)
                    h +=
                      ...
                      c +
                      "'>" +
                      this.locale.date.month_full[c] +
                      '</option>';
                  break;
                case '%d':
                  (o = 'dhx_lightbox_day_select'),
                    (e._time_format_order[1] = d);
                  for (var c = 1; 32 > c; c++)
                    h += "<option value='" + c + "'>" + c + '</option>';
                  break;
                case '%H:%i':
                  (o = 'dhx_lightbox_time_select'),
                    (e._time_format_order[0] = d);
                  var c = a,
                    u = r.getDate();
                  for (e._time_values = []; s > c; ) {
                    var g = this.templates.time_picker(r);
                    (h += "<option value='" + c + "'>" + g + '</option>'),
                      e._time_values.push(c),
                      r.setTime(r.valueOf() + 60 * this.config.time_step * 1e3);
          ...
          set_value: function(e, t, i, r) {
            function s(e, t, i) {
              for (
                var s = r._time_values,
                  a = 60 * i.getHours() + i.getMinutes(),
                  n = a,
                  d = !1,
                  l = 0;
                l < s.length;
              ...
              (e[t + o[0]].value = d ? a : n),
                d || n || (e[t + o[0]].selectedIndex = -1),
                (e[t + o[1]].value = i.getDate()),
                (e[t + o[2]].value = i.getMonth()),
                (e[t + o[3]].value = i.getFullYear());
            }
            var a,
              n,
              d = scheduler.config,
            ...
            if (d.full_day) {
              if (!e._full_day) {
                var h =
                  ...
                  '&nbsp;</label></input>';
                scheduler.config.wide_form ||
                  (h = e.previousSibling.innerHTML + h),
                  (e.previousSibling.innerHTML = h),
                  (e._full_day = !0);
              }
              var _ = e.previousSibling.getElementsByTagName('input')[0];
              (_.checked =
                0 === scheduler.date.time_part(i.start_date) &&
                0 === scheduler.date.time_part(i.end_date)),
                (l[o[0]].disabled = _.checked),
                (l[o[0] + l.length / 2].disabled = _.checked),
                (_.onclick = function() {
                  if (_.checked) {
                    var t = {};
                    scheduler.form_blocks.time.get_value(e, t, r),
                      (a = scheduler.date.date_part(t.start_date)),
                      (n = scheduler.date.date_part(t.end_date)),
                      (+n == +a ||
                        (+n >= +a &&
                          (0 !== i.end_date.getHours() ||
                            0 !== i.end_date.getMinutes()))) &&
                        (n = scheduler.date.add(n, 1, 'day'));
                  } else (a = null), (n = null);
                  (l[o[0]].disabled = _.checked),
                    (l[o[0] + l.length / 2].disabled = _.checked),
                    s(l, 0, a || i.start_date),
                    s(l, 4, n || i.end_date);
                });
            }
              ...
              for (
                var c = function() {
                    (a = new Date(
                      ...
                      (n = new Date(
                        a.getTime() + 60 * scheduler.config.event_duration * 1e3
                      )),
                      s(l, 4, n);
                  },
                  u = 0;
      ...
      (scheduler.showCover = function(e) {
        if (e) {
          ...
          t
            ? (e.style.top =
                Math.round(t + Math.max((r - e.offsetHeight) / 2, 0)) + 'px')
            : (e.style.top =
                Math.round(Math.max((r - e.offsetHeight) / 2, 0) + 9) + 'px'),
            document.documentElement.scrollWidth > document.body.offsetWidth
              ? (e.style.left =
                  Math.round(
                    i + (document.body.offsetWidth - e.offsetWidth) / 2
                  ) + 'px')
              : (e.style.left =
                  Math.round((document.body.offsetWidth - e.offsetWidth) / 2) +
                  'px');
        }
        this.show_cover();
      }),
      ...
      (scheduler._fill_lightbox = function(e, t) {
        ...
        if (scheduler.templates.lightbox_header) {
          s.push('');
          var a = scheduler.templates.lightbox_header(
            i.start_date,
            i.end_date,
            i
          );
          ...
          var n = this.templates.event_header(i.start_date, i.end_date, i),
            d = (
              this.templates.event_bar_text(i.start_date, i.end_date, i) || ''
            ).substr(0, 70);
      ...
      (scheduler.save_lightbox = function() {
        ...
        (!this.checkEvent('onEventSave') ||
          this.callEvent('onEventSave', [
            this._lightbox_id,
            e,
            this._new_event,
          ])) &&
          (this._empty_lightbox(e), this.hide_lightbox());
      }),
      ...
      (scheduler.endLightbox = function(e, t) {
        ...
        i && this._edit_stop_event(i, e),
          e && scheduler.render_view_data(),
          this.hideCover(t),
          this._custom_lightbox &&
                  ...
                  if (t.getAttribute('dhx_button'))
                    ...
                    -1 != i.indexOf('dhx_custom_button') &&
                      (-1 != i.indexOf('dhx_custom_button_')
                        ? ((s = t.parentNode.getAttribute('index')),
                          (n = t.parentNode.parentNode))
                        : ((s = t.getAttribute('index')),
                          (n = t.parentNode),
                          (t = t.firstChild))),
                      s &&
                        ((a =
                          scheduler.form_blocks[
                            scheduler.config.lightbox.sections[s].type
                          ]),
            ...
            switch (
              (r ||
                (r = i.parentNode.querySelector(
                  '.dhx_custom_button, .dhx_readonly'
                )),
              (e || t).keyCode)
            ) {
              case 32:
      ...
      (scheduler.setLightboxSize = function() {
        ...
        if (e) {
          ...
          (t.style.height = '0px'),
            ...
            (e.style.height =
              t.scrollHeight + scheduler.xy.lightbox_additional_height + 'px'),
            (t.style.height = t.scrollHeight + 'px');
        }
      }),
      ...
      (scheduler._move_while_dnd = function(e) {
        if (scheduler._dnd_start_lb) {
          ...
          (t.style.top =
            scheduler._lb_start[1] + i[1] - scheduler._dnd_start_lb[1] + 'px'),
            (t.style.left =
              scheduler._lb_start[0] +
              i[0] -
              scheduler._dnd_start_lb[0] +
              'px');
        }
      }),
      (scheduler._ready_to_dnd = function(e) {
        var t = scheduler.getLightbox();
        (scheduler._lb_start = [
          parseInt(t.style.left, 10),
          parseInt(t.style.top, 10),
        ]),
          (scheduler._dnd_start_lb =
            e && e.target
              ? [e.pageX, e.pageY]
              : [event.clientX, event.clientY]);
      }),
      (scheduler._finish_dnd = function() {
        scheduler._lb_start &&
          ((scheduler._lb_start = scheduler._dnd_start_lb = !1),
      ...
      (scheduler.getLightbox = function() {
        if (!this._lightbox) {
          ...
          (e.className = 'dhx_cal_light'),
            scheduler.config.wide_form &&
              (e.className += ' dhx_cal_light_wide'),
            scheduler.form_blocks.recurring &&
              (e.className += ' dhx_cal_light_rec'),
            /msie|MSIE 6/.test(navigator.userAgent) &&
              (e.className += ' dhx_ie6'),
            (e.style.visibility = 'hidden');
          for (
            var t = this._lightbox_template,
            ...
            (r = this._waiAria.lightboxButtonAttrString(i[s])),
              (t +=
                '<div ' +
                r +
                " class='dhx_btn_set dhx_left_btn_set " +
                i[s] +
          ...
          for (var s = 0; s < i.length; s++)
            (r = this._waiAria.lightboxButtonAttrString(i[s])),
              (t +=
                '<div ' +
                r +
                " class='dhx_btn_set dhx_right_btn_set " +
                i[s] +
          ...
          (t += '</div>'),
            (e.innerHTML = t),
            scheduler.config.drag_lightbox &&
              ((e.firstChild.onmousedown = scheduler._ready_to_dnd),
          ...
          for (var s = 0; s < a.length; s++) {
            ...
            if (n) {
              ...
              var d = '';
              if (a[s].button) {
                var r = scheduler._waiAria.lightboxSectionButtonAttrString(
              ...
              'string' != typeof l && (l = a[s].name),
                (t +=
                  ...
                  l +
                  '</label></div>' +
                  n.render.call(this, a[s])),
                (t += '</div>');
            }
          }
          for (
            var o = e.getElementsByTagName('div'), s = 0;
            s < o.length;
            s++
          ) {
            var h = o[s],
          ...
          scheduler._bindLightboxLabels(a),
          ...
          if (i.id && document.getElementById(i.id)) {
            for (
              var r = document.getElementById(i.id),
                ...
                a = scheduler._get_lightbox_section_node(i);
              a && !a.querySelector;
            ...
            if (a) {
              ...
              d &&
                ((i.inputId = d.id || 'input_' + scheduler.uid()),
                d.id || (d.id = i.inputId),
                s.setAttribute('for', i.inputId),
                (n = !1));
            }
            if (n) {
      ...
      (scheduler._init_touch_events = function() {
        ...
        if (
          (e && ((this.xy.scroll_width = 0), (this._mobile = !0)),
          this.config.touch)
        ) {
          var t = !0;
          try {
      ...
      (scheduler._touch_events = function(e, t, i) {
            ...
            return (
              'create' == t &&
                ...
                (scheduler.render_view_data = function() {
                  for (
                    var e = scheduler.getState().drag_id,
                      t = scheduler.getEvent(e),
                      i = r.y_property,
                      s = scheduler.getEvents(t.start_date, t.end_date),
                      a = 0;
                    a < s.length;
                    a++
                  )
                    s[a][i] != t[i] && (s.splice(a, 1), a--);
                  (t._sorder = s.length - 1),
                    (t._count = s.length),
                    this.render_data([t], scheduler.getState().mode);
                }),
              scheduler._on_mouse_move(e),
              'create' == t && r && (scheduler.render_view_data = s),
              e.preventDefault && e.preventDefault(),
              (e.cancelBubble = !0),
              !1
            );
        ...
        function n(e) {
          i(e) ||
            ...
            h &&
              (scheduler._on_mouse_up(t(e || event)),
        ...
        r(document.body, e[0], function(e) {
            ...
            if (r) {
              ...
              if (((l = t(e)), c))
                return l
                  ? void (
                      (d.target != l.target ||
                        Math.abs(d.pageX - l.pageX) > 5 ||
                        Math.abs(d.pageY - l.pageY) > 5) &&
                      ((_ = !0), clearTimeout(o))
                    )
                  : void (_ = !0);
            }
          ...
          r(this._els.dhx_cal_data[0], 'scroll', n),
          r(this._els.dhx_cal_data[0], 'touchcancel', n),
          r(this._els.dhx_cal_data[0], 'contextmenu', function(e) {
            return i(e)
              ? void 0
              : c
          ...
          r(this._obj, e[1], function(e) {
            if (!i(e)) {
              ...
              var r;
              if (((h = _ = !1), (c = !0), (r = l = t(e)), !r))
                return void (_ = !0);
              var s = new Date();
              if (!_ && !h && 250 > s - u)
                return (
                  scheduler._click.dhx_cal_data(r),
                  window.setTimeout(function() {
                ...
                (o = setTimeout(function() {
                  ...
                  e && -1 != t.indexOf('dhx_body') && (e = e.previousSibling),
                    ...
                    scheduler._drag_mode &&
                      'create' != scheduler._drag_mode &&
                      scheduler.for_rendered(scheduler._drag_id, function(
                        e,
                        t
                      ) {
                        (e.style.display = 'none'),
          ...
          r(this._els.dhx_cal_data[0], e[2], function(e) {
            return i(e)
              ? void 0
              : (!h && s(d, l, 200, 100) && (scheduler._block_next_stop = !0),
                h &&
                ...
                n(e),
                scheduler._block_next_stop
                  ? ((scheduler._block_next_stop = !1),
                    e.preventDefault && e.preventDefault(),
                    (e.cancelBubble = !0),
                    !1)
                  : void 0);
            ...
            r &&
              (i =
                ...
                (r._timed
                  ...
                  : scheduler.templates.day_date(r.start_date, r.end_date, r)) +
                '</div>');
          }
          'create' == scheduler._drag_mode || 'new-size' == scheduler._drag_mode
            ? (t.innerHTML =
                (scheduler.locale.labels.drag_to_create || 'Drag to create') +
                i)
            : (t.innerHTML =
                (scheduler.locale.labels.drag_to_move || 'Drag to move') + i);
        }
      }),
      (scheduler._hide_global_tip = function() {
        ...
        e &&
          e.parentNode &&
          (e.parentNode.removeChild(e), (scheduler._global_tip = 0));
      }),
      (scheduler._dp_init = function(e) {
        (e._methods = [
          ...
          (this._dp_hook_delete = function(t, i) {
            return scheduler.getEvent(t)
              ? (t != i &&
                  ('true_deleted' == this.getUserData(t, e.action_param) &&
                    this.setUserData(t, e.action_param, 'updated'),
          ...
          this.attachEvent('onConfirmedBeforeEventDelete', function(t) {
            if (this._validId(t)) {
              ...
              return 'inserted' == i || this._new_event
                ...
                : 'true_deleted' == i
                ? !0
                : (e.setUpdated(t, !0, 'deleted'), !1);
            }
          }),
          this.attachEvent('onEventChanged', function(t) {
            !this._loading &&
              this._validId(t) &&
              e.setUpdated(t, !0, 'updated');
          }),
          ...
          (e._objToJson = function(t, i, r) {
            ...
            for (var s in t)
              0 !== s.indexOf('_') &&
                (t[s] && t[s].getUTCFullYear
                  ? (i[r + s] = this.obj.templates.xml_format(t[s]))
                  : t[s] && 'object' == typeof t[s]
                  ? e._objToJson(t[s], i, r + s + '.')
                  : (i[r + s] = t[s]));
            return i;
          }),
          ...
          e.attachEvent('deleteCallback', function(e, t) {
            this.obj.getEvent(t)
              ? (this.obj.setUserData(t, this.action_param, 'true_deleted'),
                this.obj.deleteEvent(t))
              : this.obj._add_rec_marker && this.obj._update_callback(e, t);
          });
      }),
      ...
      (scheduler._skin_init = function() {
        ...
        if (
          (!scheduler.skin ||
            ('classic' !== scheduler.skin && 'glossy' !== scheduler.skin) ||
            (r = 1),
          scheduler._is_material_skin())
        ) {
          ...
          if (
            s &&
            scheduler.config.buttons_left.slice().join() == s &&
            a &&
            scheduler.config.buttons_right.slice().join() == a
          ) {
        ...
        if (
          (this._configure(scheduler.config, scheduler._skin_settings, r),
          this._configure(scheduler.xy, scheduler._skin_xy, r),
          'flat' === scheduler.skin &&
          ...
          d && (d.padding = 14),
            ...
            scheduler.attachEvent('onTemplatesReady', function() {
              ...
              scheduler.templates._old_month_day ||
                (scheduler.templates._old_month_day =
                  scheduler.templates.month_day);
              var t = scheduler.templates._old_month_day;
              if (
                ((scheduler.templates.month_day = function(i) {
                  if ('month' == this._mode) {
                    var r = e(i);
                    return (
                      1 == i.getDate() &&
                        (r =
                          scheduler.locale.date.month_full[i.getMonth()] +
                          ' ' +
                          r),
                      +i == +scheduler.date.date_part(this._currentDate()) &&
                        (r =
                ...
                var i = scheduler._els.dhx_cal_navline[0].getElementsByTagName(
                    'div'
                  ),
                  r = null,
                  s = 211,
                ...
                for (var d = 0; d < i.length; d++) {
                  ...
                  if (o) {
                    ...
                    0 === (l.className || '').indexOf('dhx_minical_icon') &&
                      l.parentNode == scheduler._els.dhx_cal_navline[0] &&
                      (r = l);
                }
                r && (r.style.left = s + 'px');
              }
        ...
        !(function(e) {
          ...
          e.fn.dhx_scheduler = function(r) {
                ...
                this.each(function() {
                  if (this && this.getAttribute)
                    if (this.getAttribute('dhxscheduler'))
                      s.push(window[this.getAttribute('dhxscheduler')]);
                    else {
                      var e = 'scheduler';
                      t &&
                        ((e = 'scheduler' + (t + 1)),
            ...
            return i[r]
              ? i[r].apply(this, [])
              : void e.error(
                  'Method ' + r + ' does not exist on jQuery.dhx_scheduler'
                );
          };
        })(jQuery),
      (function() {
          ...
          a = function(t, a) {
            ...
            e(this, t, a),
              (s = setTimeout(function() {
                return n.callEvent('onBeforeViewChange', [
                  l,
                  d,
                  a || n._mode,
                  t || n._date,
                  ...
                  ? (i.call(n, t, a),
                    n.callEvent('onViewChange', [n._mode, n._date]),
        ...
        scheduler.attachEvent('onSchedulerReady', function() {
          scheduler.config.delay_render
            ? ((scheduler.setCurrentView = a), (scheduler.updateView = n))
            : ((scheduler.setCurrentView = t), (scheduler.updateView = i));
        });
      })();
  ...
  dhtmlx &&
    dhtmlx.attaches &&
    (dhtmlx.attaches.attachScheduler = function(e, t, i, r) {
      var i =
          i ||
        ...
        s = document.createElement('DIV');
      return (
        (s.id = 'dhxSchedObj_' + this._genStr(12)),
        (s.innerHTML =
          '<div id="' +
          s.id +
        ...
        this.attachObject(s.id, !1, !0),
        (this.vs[this.av].sched = r),
        (this.vs[this.av].schedId = s.id),
        (r.setSizes = r.updateView),
